describe('Events', () => {
  ...
  test('createOrUpdateDraft correctly creates a new draft', async () => {
    // TODO: Implement test
  ...
  test('createOrUpdateDraft correctly updates an existing draft', async () => {
    // TODO: Implement test
  ...
  test('publishEvent fails for unverified hosts', async () => {
    // TODO: Implement test
  ...
  test('publishEvent succeeds for verified hosts', async () => {
    // TODO: Implement test
  ...
  test('getOrCreateLocation returns existing location', async () => {
    // TODO: Implement test
  ...
  test('getOrCreateLocation creates a new location', async () => {
    // TODO: Implement test
